   ...
   return (
      <form onSubmit={ onSubmitHandler } className="min-h-[80vh] flex items-center justify-center">
         <div className="flex flex-col gap-4 p-8 min-w-[340px] sm:min-w-96 border border-[#B2DFDB] rounded-xl bg-[#E0F2F1] text-[#4A4A4A] text-sm shadow-md">
            ...
            <button
               type="submit"
               className={ `w-full bg-[#008080] py-2 rounded-md text-base text-white cursor-pointer transition-all duration-300 hover:bg-[#006666] hover:scale-105 ${loading ? "opacity-50 cursor-not-allowed" : ""
                  }` }
            >

   ...
   return dashData && (
      <div className='m-5'>
         ...
         <div className='bg-white'>
            <div className='flex item-center gap-2.5 px-4 py-4 mt-10 rounded-t border border-white'>
            ...
            <div className='pt-4 border border-white border-t-0'>
               ...
               { dashData.latestAppointments.map((item, index) => (
                  <div className='flex items-center gap-3 px-6 py-3 hover:bg-gray-100' key={ index }>
                     <img className='w-10 rounded-full' src={ item.docData.image } alt='Doctor Image' />
